...
#### **Windows**
1. Download MySQL Installer from the .
...
#### **macOS**
1. Download MySQL DMG Archive from the .
...
#### **Windows**
1. Download the precompiled binaries from .
...
#### **Windows**
1. Download the SQL Server installer from the .
...
#### **macOS** (Using Docker)
1. Install Docker for macOS from the .
...
#### **Windows/macOS/Linux**
1. Download Oracle Database Express Edition (XE) from the .
...
#### **Windows**
1. Download the MariaDB installer from the .
